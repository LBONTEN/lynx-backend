# Mu Authorization configuration file
# Used to decide which people get to access what
# Links is an open project so to be honest this file won't get much attention
